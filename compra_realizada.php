  ...
  <main class="seguros-bg">
    <div class="titulo-bg">
      <div class="titulo container">
        <h1 class="font-1-xxl cor0">Agradecemos sua compra<span class="corp1">!</span></h1>
        <p class="font-2-l-b cor5" style="margin-top: 10px;">Em breve, você receberá um e-mail com os detalhes do seu pedido e as próximas etapas.</p>
      </div>
    </div>
